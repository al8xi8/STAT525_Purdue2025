/* (Bundled for Jenner — kept the two-factor ANOVA blocks (Q1, Q2, Q6) intact; the `means A B A*B;` cross-term means and the Q5 tile-strength PROC GLM blocks were dropped from this bundle.) */
